...
CORS(ocr_bp,supports_credentials=True,allow_headers=True,origins="https://ink-grader-demo.vercel.app")
    ...
    try:
        ...
        if image and question and marks:
            ...
            safe_grading_result = {
                ...
                "evaluations": {str(k): v for k, v in grading_result["evaluations"].items()}
            }
